 ...
 ******************************************************************************/
     ...
     * lost.
     */
    credentialSecret: "jetpace-ems-2024",
 ...
 ******************************************************************************/
    ...
    adminAuth: {
        ...
        users: [{
            username: "admin",
            password: "$2b$08$dfblVmqF1oFeQnKAZ3kIcuEqfOfvauc6/SvpuXlXYia8F4t951ZEe",
            permissions: "*"
        }]
    },
 ...
 ******************************************************************************/
    ...
    */
     ...
     */
contextStorage: {
    default: { module: 'localfilesystem' },      // default = memory
    file: { module: 'localfilesystem', config: { flushInterval: 30 } }  // flush every 30s not instantly
},
